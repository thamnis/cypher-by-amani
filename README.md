...
## 🥇Point de depart (Execution dans le terminal)
...
- methode cryptage : *Code ce Cesar*

---

## 🏅Limite
- Integration d'un **interface graphique**
- Intégration d'autres **methodes de cryptage**
...
## 📚Fonctionnalités 
- Recuperer **données** par saisir ou à partir d'un fichier externe
- Demander l'**Action** à effectuer
- Demander la **Methode de cryptage**
